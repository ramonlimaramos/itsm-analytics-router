...
if(themeColour == 'white'){
	...
	var backColor = '#F23C25';
	var metric = '#66CE39';	// COR DAS LINHAS NOS GRÁFICOS #F2F2F2
	var pointerColor = '#898989'; 
	var pageBackgorund = '#2b2b2b';	
	var pieSegColors = [metric,'#c0c0c0','#8e8e8e','#5b5b5b','#292929'];
	var pieTrack = backColor;
	var pieBar = metric;
	var gaugeTrackColor = '#66ce39'; // OLD = '#4f4f4f'
	var gaugeBarColor = '#f23c25';	 // OLD = '#898989'
	var gaugePointerColor = '#f2f2f2';
...
$(document).ready(function(){
	...
	*/								
	$('.cf-rag').each(function(){
		// Dummy data for RAG
		ragData = [0,0,100];
		ragLabels = ['USR / IDL','SYS / BTC','Free'];
		ragOpts = {postfix:'%'}
